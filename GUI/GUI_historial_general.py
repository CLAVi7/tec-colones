...
def historial_general():
    ...
    calendario_inicial = DateEntry(ventana, width=16, font=("Helvetica", 11), background='#8DC67E', foreground='black',
                                   borderwidth=2)
    ...
    calendario_final = DateEntry(ventana, width=16, font=("Helvetica", 11), background='#8DC67E', foreground='black',
                                 borderwidth=2)
